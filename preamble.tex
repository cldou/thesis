...
\usepackage{subfigure}
%\usepackage[font=small]{caption}  % 注释掉，避免重复
\usepackage{mathrsfs}
\usepackage{times}
\usepackage{amsmath,amssymb,latexsym}
\usepackage{epsfig}
...
\usepackage{eqparbox}
\usepackage{subfigure}
%\usepackage[justification=centering]{caption}  % 注释掉，避免重复
%\usepackage{float}
%\usepackage{subfloat}
\usepackage{color}
\usepackage{slashbox}
...
%%%%%%%%%%%%%%%%% 页面布局设置 %%%%%%%%%%%%%%%%%%%%%%%%
%% 删除了原来手动计算 textheight 的代码，因为会与 geometry 冲突
%% 设置页眉页脚的高度
...
%% 关键修正：使用 geometry 宏包正确设置页边距
%% 对于双面打印 (twoside)：
%%   - inner = 装订侧边距 (奇数页左边，偶数页右边) = 4cm
%%   - outer = 外侧边距 (奇数页右边，偶数页左边) = 2.5cm
%%   - top = 上边距 = 2.5cm
%%   - bottom = 下边距 = 2.5cm
%% 使用 includehead 和 includefoot 确保页眉页脚在边距计算内
%% 使用 heightrounded 避免 "Underfull \vbox" 警告
\usepackage[
    a4paper,
    inner=4cm,
    outer=2.5cm,
